                    ...
                    <div class="row">
                        <div class="col-9 col-lg-3">
                            <div class="site-branding">
                                <h1 class="site-title"><a href="home" rel="home">Psycholo<span>gy</span></a></h1>
                            </div><!-- .site-branding -->
                        </div><!-- .col -->
                        ...
                        <div class="col-3 col-lg-9 flex justify-content-end align-content-center">
                            <nav class="site-navigation flex justify-content-end align-items-center">
                              ...
                              <button onclick="document.getElementById('modal-wrapper').style.display='block'" style="width:100px; margin-left:100px;">
Login</button>
...
<img src="<c:url value="/resources/images/download (1).jpg"/>" alt="avatar" class="avatar">
