    ...
    <div class="container">
        ...
        <form>
            ...
            Course : <select name="Course">
                              <option value="SPPU">BAFY</option>
                              <option value="BAMU">BASY</option>
                              <option value="SGU">BATY</option>
                              <option value="NYU">MAFY</option>
                              <option value="NYU">MASY</option>
                              <option value="NYU">Set</option>
                              <option value="NYU">Net</option>
                        </select>
            Sem : <select name="Sem">
                              <option value="SPPU">1st</option>
                              <option value="BAMU">2nd</option>
                              
                        </select>
            <input type="submit" name="asfasfa">
        </form>
        </div>    
